...
public abstract class ClockDisplay extends JFrame implements Observer {
    ...
    public abstract void refreshClockDisplay(JTextArea clockDisplay, String hour, String minute, String second);
    ...
    public void update(Subject subject) {
        ...
        refreshClockDisplay(clockDisplay, timeStam.getHour().toString(), timeStam.getMinute().toString(), timeStam.getSecond().toString());
    }
